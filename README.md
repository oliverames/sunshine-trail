...
This directly connects to Lawson's "chain of freshness" brand promise—beer kept cold from brewing until it reaches your lips.
...
- **Google Maps link** that brings you to navigation to their location
...
If I click "show route on map," it will zoom the map out so that the map and trail fit within my viewport window.
...
What's really cool is if the user doesn't click "Get Itinerary" after about 30 seconds, this popup will come up anyway. This is part of an effective inbound strategy.
...
Of course you can type your own information in here. But what's really cool is that it'll do it for you. We're reducing the friction that someone would have to do to sign up for a newsletter.
